...
<br><hr>
        ...
        <div class="memo_body">
            ...
            <table>
                ...
                @foreach($sells as $sell)
                    ...
                    <tr>
                        <td>{{$count}}</td>
                        <td style="width: 200px;">{{$sell->item->company}} {{$sell->item->title}} {{$sell->item->model}} @if($sell->serial_no!=null) ({{$sell->serial_no}}) @endif</td>
                        <td>{{$sell->no_item}}</td>
        ...
        <div class="total" style="margin-left: 470px;">
            ...
            <p><b>Sold by:</b> {{$user}}</p>
            @endif

            @if($submit==1)
                <?php
                    $perInstallment = $installment->amount/$installment->no_of_inst;
                    $perInstallment = ceil($perInstallment);
                ?>
                    <p><b>Sub Total:</b> {{$amountSum*1.04}}/-</p>
                    <p><b>Vat:</b></p>
                    <p><b>Total:</b></p>
                    <p><b>Down Payment:</b> {{($amountSum*1.04)-$installment->amount}}/-</p>
                    <p><b>Due (Including Interest):</b> {{$installment->amount}}/-</p>
            ...
            @endif
                ...
                @if($submit==2)
                    ...
                    @if($installment->no_of_inst - $installment->inst_paid==0)
                        <?php
                            $perInstallment = 0;
                        ?>
                    @else
                    ...
                    <p><b>Vat:</b></p>
                    <p><b>Total:</b></p>
                    <p><b>Installment Payment:</b> {{$install_pay->amount}}/-</p>
        ...
        <div class="signDiv" style="margin-left: 130mm;">
            _________________________________
            <p style="margin-left: 30px;">Authorized Signature
        </div>
<br>
        <div class="bangla">
