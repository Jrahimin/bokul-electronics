    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12">
                <button type="submit" id="submitSearch" name="submitSearch" value="submitSearch" class="btn btn-lg btn-primary" style="margin-left: 11.5%;font-weight:bold;">Search Installment</button>
            </div>
        </div>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12">
                <button type="submit" id="submitInstall" name="submitInstall" value="submitInstall" class="btn btn-lg btn-primary" style="margin-left: 11.5%;font-weight:bold;">Submit Installment</button>
            </div>
        </div>
