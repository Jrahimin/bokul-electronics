...
@section('content')
    ...
    @if($load!=0)
        ...
        <div class="col-sm-offset-2 col-sm-12">
            <button type="submit" id="submitMemo" name="submitMemo" value="submitMemo" onClick="check(event)" class="btn btn-lg btn-primary" formtarget="_blank" style="margin-top: 1%; margin-left: 16.5%;font-weight:bold;">Create Memo</button>
        </div>
                </fieldset>
        </form>
</div>
