        ...
        <fieldset>
            ...
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-12">
                    <button type="submit" id="submitPayInstall" name="submitPayInstall" value="submitPayInstall" class="btn btn-lg btn-primary" style="margin-left: 14.5%;font-weight:bold;">Pay Installment</button>
                </div>
            </div>
