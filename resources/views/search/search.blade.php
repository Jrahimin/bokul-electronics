...
@section('content')
    ...
    {!! Form::open(['method'=>'GET','action'=>'SearchController@search_process','class'=>'form-horizontal']) !!}
    {{csrf_field()}}
    <fieldset>
        ...
        <div class="form-group">
            ...
            <div class="col-sm-4">
                <select class="form-control" id="search_type" name="search_type"  required="required" onchange="showOthers(this.value);">
                        ...
                        <option value="by_user">Search by User</option>
                </select>
            </div>
        </div>
        ...
        <div class="form-group" style="display: none" id="by_user">
