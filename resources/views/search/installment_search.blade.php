    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12" style="margin-left: 14.5%;">
                <button type="submit" id="submit" name="submit" value="submit" class="btn btn-lg btn-primary" style="margin-left: 25%;font-weight:bold;" formtarget="_blank">Search</button>
            </div>
        </div>
</form>
        {!! Form::open(['method'=>'POST','action'=>'SearchController@installment_search_process','class'=>'form-horizontal']) !!}
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12" style="margin-left: 14.5%;">
                <button type="submit" id="installment_search" name="installment_search" value="installment_search" class="btn btn-lg btn-primary" style="margin-left: 13%;font-weight:bold;" formtarget="_blank">All Due Installments</button>
            </div>
        </div>
