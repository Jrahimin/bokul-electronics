...
class ItemsController extends Controller
{
    ...
    public function create_memo(Request   $request)
    {
        if($request->has('submitMemoOther'))
        {
            ...
            if($userType=="Admin")
                return view('item.create_memo', compact('sells', 'customer', 'paid', 'installment', 'submit'));
            else
                return "Please Log in as Admin to access this page";
        }
        ...
        if($request->has('submitMemo'))
        {
            ...
            $userType = auth::user()->type;
            if($userType=="Admin")
                return view('item.create_memo', compact('sells', 'customer', 'paid', 'submit'));
            else
                return "Please Log in as Admin to access this page";
        }
  ...
  //          $lastId = $last->id;
    ...
    public function install_payStore(Request $request)
    {
        ...
        if($request->has('submitMemoInstallPay'))
        {
            ...
            $userType = auth::user()->type;
            if($userType=="Admin")
                return view('item.create_memo', compact('sells', 'customer', 'installment', 'install_pay', 'submit'));
            else
                return "Please Log in as Admin to access this page";
        }
