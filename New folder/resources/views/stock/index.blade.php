    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12">
                <button type="submit" id="submit" name="submit" value="submit" class="btn btn-lg btn-primary" style="margin-left: 23.5%;font-weight:bold;">Search</button>
            </div>
        </div>

        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12">
                <button type="submit" id="allSubmit" name="allSubmit" value="allSubmit" class="btn btn-lg btn-primary" style="margin-left: 15.5%;font-weight:bold;">Search All Stocks</button>
            </div>
        </div>
