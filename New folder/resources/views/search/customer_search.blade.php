    ...
    <fieldset>
        ...
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12" style="margin-left: 14.5%;">
                <button type="submit" id="submit" name="submit" value="submit" class="btn btn-lg btn-primary" formtarget="_blank" style="margin-left: 25.5%;font-weight:bold;">Search</button>
            </div>
        </div>
        ...
        @if($userType=="Admin")
            <div class="form-group">
                <div class="col-sm-offset-2 col-sm-12" style="margin-left: 14.5%;">
                    <button type="submit" id="submitAllNo" name="submitAllNo" value="submitAllNo" class="btn btn-lg btn-primary" formtarget="_blank" style="margin-left: 21.5%;font-weight:bold;">All Numbers</button>
                </div>
            </div>

        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12" style="margin-left: 14.5%;">
                <button type="submit" id="submitAll" name="submitAll" value="submitAll" class="btn btn-lg btn-primary" formtarget="_blank" style="margin-left: 20%;font-weight:bold;">All Customers</button>
            </div>
        </div>
