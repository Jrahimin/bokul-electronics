    ...
    <input type="hidden" id="date" name="date" value="{{\Carbon\Carbon::today()->setTimezone('Asia/Dacca')->toDateString()}}">
        <div class="form-group">
            <div class="col-sm-offset-2 col-sm-12">
                <button type="submit" id="submitInstall" name="submitInstall" value="submitInstall" class="btn btn-lg btn-primary" style="margin-left: 15.5%;font-weight:bold;">Submit Installmet</button>
            </div>
        </div>
