...
@section('content')
    ...
    @if($load!=0)
            <fieldset>
                ...
                <div class="form-group">
                    ...
                    <input type="hidden" name="total" id="total" value="{{$amountSum}}">
                </div>
                @endif
    ...
    <br>
        ...
        <div class="InstallmentDiv">
            ...
            <div class="col-sm-offset-2 col-sm-12">
                <button type="submit" id="submitPay" name="submitPay" value="submitPay" onClick="check(event)" class="btn btn-lg btn-primary" style="margin-top: 1%; margin-left: 15.3%;font-weight:bold;">Create Installment</button>
            </div>
            <label id="successLabel" style="margin-left: 30%;">{{$msgPay}}</label>
        </div>
            </form>
    ...
    <div class="memo" style="margin-bottom: 10%;">
        {!! Form::open(['method'=>'GET','action'=>'ItemsController@create_memo','class'=>'form-horizontal']) !!}
                ...
                <div class="col-sm-offset-2 col-sm-12">
                    <button type="submit" id="submitMemoOther" name="submitMemoOther" value="submitMemoOther" class="btn btn-lg btn-primary" formtarget="_blank" style="margin-top: 1%; margin-left: 15.3%;font-weight:bold;">Create Memo</button>
                </div>
